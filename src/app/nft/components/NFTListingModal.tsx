    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      ">
        ...
        <div className="flex items-center justify-between p-6 border-b border-border-default">
          <h2 className="text-xl font-medium text-text-primary">List NFT for Sale</h2>
          <button
            onClick={onClose}
        ...
        <div className="p-6 space-y-6">
          ...
          <div>
            ...
            <div className="flex gap-2">
              ...
              <select
                ...
                "
              >
                {NFT_CONFIG.supportedCurrencies.map((c) => (
          ...
          {/* Error Message */}
          {error && (
            <div className="p-3 rounded-lg bg-error-muted border border-border-error text-error text-sm">
              {error}
            </div>
          )}
        </div>
